...
export default function LoginAfiliadoPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        <h1 className="text-xl font-medium text-center">Panel de afiliado</h1>

        <div className="space-y-2">
          <label htmlFor="email" className="text-sm text-black/60">Email</label>
        ...
        <div className="space-y-2">
          <label htmlFor="password" className="text-sm text-black/60">Contraseña</label>
